...
KarKontroller::KarKontroller(const LinearActuatorConfig throttle_config,
                             ...
                             uint8_t starter_pin,
                             Arduino_GPS* gps) : throttle_(throttle_config.driver,
                                                           throttle_config.motor,
                                                           throttle_config.pos_pin),
                                                 brake_(brake_config.driver,
                                                        brake_config.motor,
                                                        brake_config.pos_pin),
                                                 steering_(steering_config.driver,
                                                           steering_config.motor,
                                                           steering_config.pos_pin),
                                                 shifter_(shifter_config.driver,
                                                          shifter_config.motor,
                                                          shifter_config.pos_pin),
